        ...
        "schemas": {
            ...
            "models.FarmingOutput": {
                "properties": {
                    ...
                    "tools": {
                        "$ref": "#/components/schemas/models.SkillToolsResult"
                    },
                    "uniqueGolds": {
                        "type": "integer"
                    }
        ...
        "/api/embed/{uuid}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Profile ID (optional, defaults to selected profile)",
                        "in": "query",
                        "name": "profileId",
                        "schema": {
                            "type": "string"
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "description": "Returns fetched_at timestamp and array of emojis"
                    },
                    "500": {
                        "content": {
                            "application/json": {
                        ...
                        "description": "Failed to fetch or parse emojis"
                    }
                },
        ...
        "/api/inventory/search/{uuid}/{profileId}/{searchParam}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Search parameter to filter inventory items",
                        "in": "path",
                        "name": "searchParam",
                        "required": true,
                        "schema": {
